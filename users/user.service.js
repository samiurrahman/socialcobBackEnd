...
async function getAll(username) {
    return await User.find(
        ...
        }).select('-hash -email -gender -userdata -accessKeyId -secretAccessKey -aboutMe -bookmark -bookmarked -createdDate -region -provider');
}
// Ends
...
async function resetpassword({ username, email }) {
    ...
    let mailOptions = {
        from: '"socialcob" <info@socialcob.com>', // sender address
